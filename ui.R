...
=======
      ...
      With all three of these interactive widgets, we were able to compare the quantity of films
      released by various distributors in more detail."),
>>>>>>> ff3c62fea4b2f555850e535baa331f8217ade60e
      )
    )
  ),
...
### Stuff for 3rd tab
  ...
  tabPanel("Distributor vs Movie World Sales", fluidPage(
    ...
    sidebarLayout(
      ...
      p("This chart shows the number of movies produced by each movie distributor and the 
        revenue generated from worldwide sales for each movie. You can use the slider and 
        drop-down function to analyze the revenue generated by a specific producer. 
        To get a brief description of a movie, simply enter its name in the text input box, 
        and a short summary will be displayed below the dot plot."),
      p("The dot plot highlights the movie that generated the most revenue for the 
      distributor, allowing us to see the types of movies each distributor tends to make 
      and how well they perform in terms of revenue.")
    )
  ),
### 4th tab
